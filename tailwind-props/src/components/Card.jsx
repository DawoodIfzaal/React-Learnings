...
function Card({price = 0, isThere = "ching chong", thisObj= {username : "default"}}){
    return (
        ...
        <div className="flex flex-col py-3 px-3 pb-7 -mt-4 bg-black ">
          <div className="flex justify-between font-mono">
            <p className="font-light text-sm">Bored ape nft accidental</p>
            <p className="font-light text-sm">Price</p>
          </div>
          <div className="flex  justify-between font-mono">
            <p>{isThere}</p>
            <p>{thisObj.username}</p>
          </div>
        </div>
      </div>
    )
